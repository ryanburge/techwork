...
ggsave("D://techwork/sscr/friesen_color_fig3.png", type = "cairo-png", width = 30, height = 15, dpi = 300, c)
...
ggsave("D://techwork/sscr/friesen_grayscale_fig3.png", type = "cairo-png", width = 30, height = 15, dpi = 300, c)
